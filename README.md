...
*   `7_v2raya-proxy.sh`: Installs and configures v2rayA proxy.
...
*   `doc/PROGRAM_DESCRIPTIONS.md`: Contains detailed descriptions of programs installed by the scripts.
*   `doc/antigravity-isolation.md`: Documentation on isolated environment setup.
*   `doc/v2raya_guide.md`: Guide for using v2rayA.
