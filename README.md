...
*   `docs/TUI_MENU_GUIDE.md` - Инструкция по управлению проектом через TUI-меню (новое).
*   `docs/TIMESHIFT_SNAPSHOT_MANAGEMENT.md` - Руководство по управлению снапшотами Timeshift, включая автоматическое удаление (новое в 2025 году).
